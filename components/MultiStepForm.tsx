          ...
          <FormikStep
            ...
            validationSchema={object({
              fullName: string()
                ...
                .min(3, `Seu nome precisa ter pelo menos 3 letras`),
          ...
          >
            ...
            <Box paddingBottom={2}>
              <Field
                ...
                Label={{
                  label: "Desejo receber informações e ofertas no meu email",
                }}
              />
            </Box>
          </FormikStep>
...
export function CustomDropdown({ name }: { name: string }) {
  ...
  return (
    <FormControl fullWidth error={!!props.error}>
      <InputLabel htmlFor="job"></InputLabel>
      <Field
        component={Select}
        native
        name="job"
      ...
      >
        {field.value !== "EMPTY" ? null : (
          <option value="EMPTY">Selecione sua situação de trabalho</option>
        )}
